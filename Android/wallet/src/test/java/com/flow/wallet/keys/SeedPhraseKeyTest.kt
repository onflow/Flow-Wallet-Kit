...
//        val twPrivateKey = hdWallet.getKey(CoinType.FLOW, 0, 0, 0, 0)
//        val twPublicKey = twPrivateKey.getPublicKeySecp256k1(false)
//
//        val keyFactory = KeyFactory.getInstance("EC")
//        val privateKeySpec = PKCS8EncodedKeySpec(twPrivateKey.data())
//        val publicKeySpec = X509EncodedKeySpec(twPublicKey.data())
//
//        val keyPair = KeyPair(
